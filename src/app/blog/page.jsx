...
const blogPosts = [
  {
    id: 1,
    title:
      "The Future of Remote Work: How SaaS Tools Are Shaping Tomorrow's Workplace",
    excerpt:
    ...
    image:
      "https://images.pexels.com/photos/4792369/pexels-photo-4792369.jpeg?auto=compress&cs=tinysrgb&w=600",
  },
  {
    id: 2,
    title:
      "Boosting Team Productivity: 10 Automation Strategies That Actually Work",
    excerpt:
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Stay updated with the latest trends in productivity, remote work,
              and team collaboration. Learn from our experiences and industry
              insights.
            </p>
          </div>
