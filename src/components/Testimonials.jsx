...
const testimonials = [
  {
    ...
    content:
      "CloudFlow has revolutionized how our team collaborates. The automation features alone have saved us 20+ hours per week.",
    rating: 5,
  },
  {
    name: "Michael Chen",
  ...
  },
  {
    ...
    content:
      "Switching to CloudFlow was the best decision we made this year. Our productivity has increased by 40%.",
    rating: 5,
  },
  {
    name: "David Thompson",
  ...
  },
  {
    ...
    content:
      "CloudFlow's integration capabilities are outstanding. We connected all our tools in just one afternoon.",
    rating: 5,
  },
  {
    name: "James Wilson",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-xl text-gray-600 leading-relaxed">
            See what our customers are saying about CloudFlow and how it&apos;s
